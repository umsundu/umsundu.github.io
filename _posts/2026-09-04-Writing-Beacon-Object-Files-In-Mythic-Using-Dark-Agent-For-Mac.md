...
In this walkthrough, we will go from a clean **Linux box** to a working **BOF** running inside a **Dark-Agent beacon** on a **Mac**. We will cover how the **loader** works, the **four rules** that make or break a **BOF**, the **build toolchain**, and a complete real world example. By the end, you will be able to write, build, and run your own **BOFs**.
